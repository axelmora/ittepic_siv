        ...
        <div class="container">
            <div class="section">
                ...
                <div class="row center-align">
                    ...
                    <div class="col s6 center-align card-panel grey lighten-5"><br>REPORTE DE INSTANCIAS POR FECHAS<div class="input-field center-align">
                            <div id="buscador">
                                ...
                                <?= form_open(base_url() . 'index.php/c_generari_pdf/validar') ?>
