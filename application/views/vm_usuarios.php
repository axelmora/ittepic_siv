        ...
        <div class="container">
            <div class="section">
                ...
                <div class="col s6 center-align card-panel grey lighten-5">
                    <table id="tabla_admin_usuarios" class="display responsive-table">
                        <thead>
                            <tr>
                                <th><b>Usuario</b></th>
                                <th><b>Nombre</b></th>
                        ...
                        <tbody>
                            <?php foreach ($usuarios as $item): ?>
                                <tr>
                                    ...
                                    <td>
                                        <form method="post" action="<?php echo base_url() . "index.php/cm_usuarios/actualizar" ?>">
                                            <input type="text" name="idu" id="idu" style="visibility:hidden; margin-top:-60px; margin-right:20px; vertical-align:" value="<?php echo $item->id; ?>"   />
                                            <input type="text" name="nombres" id="nombres" value="<?php echo $item->nombre_usuariosistema; ?>" placeholder="Introduce los datos"  />
                                    </td>
                                    <td>
                                        <input type="text" style="width: 100%; padding: 5px; border: 1px solid #d4d4d4; border-bottom-right-radius: 5px; border-top-right-radius: 4px; border-bottom-left-radius: 5px; border-top-left-radius: 4px; line-height: 1.5em; float: left; box-shadow: inset 0px 2px 2px #ececec; outline: 0; border: 1px solid #bbb;" name="usuarioi" id="usuarioi" value="<?php echo $item->usuario; ?>" placeholder="Introduce los datos"  />
                                    </td>
                                    <td>
                                        <input type="text" style="width: 100%; padding: 5px; border: 1px solid #d4d4d4; border-bottom-right-radius: 5px; border-top-right-radius: 4px; border-bottom-left-radius: 5px; border-top-left-radius: 4px; line-height: 1.5em; float: left; box-shadow: inset 0px 2px 2px #ececec; outline: 0; border: 1px solid #bbb;" name="pass" id="pass" value="<?php echo $item->pass; ?>" placeholder="Contraseña"  />
                                    </td>
                                    <td>
                                        <button type="submit" style=" border: 0; background: transparent">
                                            <img src="<?php echo base_url(); ?>images/button-bg.png" width="0" height="0" alt="submit" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="material-icons blue-text">autorenew</i>
                                        </button></form>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
