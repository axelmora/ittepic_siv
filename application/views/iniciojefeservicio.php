        ...
        <div class="section no-pad-bot" id="index-banner">
            <div class="container">
                ...
                <div class="row center">
                    ...
                    Servicio Social - Panel de Administración
        ...
        <div class="container">
            ...
            <div class="section">
                ...
                <div class="row">
                    ...
                    <a href="<?php echo base_url(); ?>index.php/c_noticias">
                ...
                <a href="<?php echo base_url(); ?>index.php/c_instancias">
                    <div class="col s12 m4 center">

                        <div class="card-panel grey lighten-5 z-depth-1">
                            <div class="row valign-wrapper">
                                <div class="col s6">
                                    <img src="<?php echo base_url(); ?>images/logoinstancias.png" alt="" class="circle responsive-img"> <!-- notice the "circle" class -->
                                </div>
                                <div class="col s6">
                                    <span class="black-text">
                                        <h5 class="light">Instancias</h5>
                                    </span>
                                </div>
                            </div>
                        </div>
