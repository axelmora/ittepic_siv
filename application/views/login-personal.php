...
<html lang="es">
    ...
    <body>
        <form class="grey lighten-2" method="post" action="<?php echo base_url() . "index.php/Logeo/new_user" ?>">
            <br>&nbsp;
            <br>&nbsp;
            <div class="rowsa">
                <input class="slide-up" type="text" name="usuario" size="6" id="usuario" placeholder="Introduce tu usuario" /><label for="actividadgi">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Usuario&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
            </div>
            <br>&nbsp;
            <br>&nbsp;
            <br>&nbsp;
            <div class="rowsa">
                <input class="slide-up" type="password" name="pass" size="6"  id="pass" placeholder="Introduce tu contraseña" /><label for="actividadgi">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Contraseña&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
            </div>
            <br>&nbsp;
            <br>&nbsp;
