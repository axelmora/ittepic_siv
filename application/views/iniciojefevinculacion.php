        ...
        <div class="section no-pad-bot" id="index-banner">
            <div class="container">
                ...
                <div class="row center">
                    ...
                    <?= $this->session->userdata('alias') ?> - Panel del Sistema
        ...
        <div class="container">
            ...
            <div class="section">
                ...
                <div class="row">
                    ...
                    <a href="<?php echo base_url(); ?>index.php/panel_servicio">
                        <div class="col s12 m4 center">

                            <div class="card-panel grey lighten-5 z-depth-1">
                                <div class="row valign-wrapper">
                                    <div class="col s6">
                                        <img src="<?php echo base_url(); ?>images/logoservicio.png" alt="" class="circle responsive-img"> <!-- notice the "circle" class -->
                                    </div>
                                    <div class="col s6">
                                        <span class="black-text">
                                            <h5 class="light">Servicio Social</h5>
                                        </span>
                                    </div>
                                </div>
                            </div></a>
                ...
                <a href="<?php echo base_url(); ?>index.php/panel_vinculacion/residencia">
                    <div class="col s12 m4 center">

                        <div class="card-panel grey lighten-5 z-depth-1">
                            <div class="row valign-wrapper ">
                                <div class="col s6">
                                    <img src="<?php echo base_url(); ?>images/residencia.png" alt="" class="circle responsive-img"> <!-- notice the "circle" class -->
                                </div>
                                <div class="col s6">
                                    <span class="black-text">
                                        <h5 class="light">Residencia profesional</h5>
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col s12 m4 center">
                        ...
                        <div class="card-panel grey lighten-5 z-depth-1">
                            <div class="row valign-wrapper">
                                ...
                                <div class="col s6">
                                    <span class="black-text">
                                        <h5 class="light">Centro de idiomas</h5>
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col s12 m4 center">
                        ...
                        <div class="card-panel grey lighten-5 z-depth-1">
                            <div class="row valign-wrapper">
                                ...
                                <div class="col s6">
                                    <span class="black-text">
                                        <h5 class="light">Servicio Externo</h5>
                                    </span>
                                </div>
                            </div>
                        </div></a>
                ...
                <div class="col s12 m4 center">
                    ...
                    <div class="card-panel grey lighten-5 z-depth-1">
                        <div class="row valign-wrapper ">
                            ...
                            <div class="col s6">
                                <span class="black-text">
                                    <h5 class="light">Visitas a empresas</h5>
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col s12 m4 center">
                    ...
                    <div class="card-panel grey lighten-5 z-depth-1">
                        <div class="row valign-wrapper">
                            ...
                            <div class="col s6">
                                <span class="black-text">
                                    <h5 class="light">Incubadora de empresas</h5>
                                </span>
                            </div>
                        </div>
                    </div>
