...
<html lang="en">
    <head>
        ...
        <title>SIV :: PANEL SUBDIRECTOR ACADÉMICO:</title>
        ...
        <div class="section no-pad-bot" id="index-banner">
            <div class="container">
                ...
                <div class="row center">
                    ...
                    Subdirector Académico - Panel de Administración
        ...
        <div class="container">    
            ...
            <div class="section">
                ...
                <div class="row">
                    ...
                    <a href="<?php echo base_url(); ?>index.php/Residencia/SubdirectorAcademico/Panel_subdirectoracademico/informacion_procedimiento">
                    ...
                    <a href="<?php echo base_url(); ?>index.php/Residencia/SubdirectorAcademico/Panel_subdirectoracademico/autorizar_dictamen">
                        <div class="col s12 m5 right">
