        ...
        <div class="container">    
            ...
            <div class="section">
                ...
                <div class="row">
                    ...
                    <a href="<?php echo base_url(); ?>index.php/Residencia/CoordinadorCarrera/Panel_coordicarrera/informacion_procedimiento">
                    ...
                    <a href="<?php echo base_url(); ?>index.php/Residencia/CoordinadorCarrera/Panel_coordicarrera/noticias_residencia">
                        <div class="col s12 m5 l4 center">       
                            <div class="card-panel grey lighten-5 z-depth-1">
                                <div class="row valign-wrapper ">
                                    <div class="col s6">
                                        <img src="<?php echo base_url(); ?>images/noticias.png" alt="" class="responsive-img"> <!-- notice the "circle" class -->
                                    </div>
                                    <div class="col s6">
                                        <span class="black-text">
                                            <h5 class="light">Noticias de Residencia Profesional</h5>
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <a href="<?php echo base_url(); ?>index.php/Residencia/CoordinadorCarrera/Panel_coordicarrera/consulta_banco_proyectos">
                ...
                <div class="row">
                    <a href="<?php echo base_url(); ?>index.php/Residencia/CoordinadorCarrera/Panel_coordicarrera/verifica_dictamen">
                        <div class="col s12 m5 left">       
                            <div class="card-panel grey lighten-5 z-depth-1">
                                <div class="row valign-wrapper ">
                                    ...
                                    <div class="col s6">
                                        <span class="black-text">
                                            <h5 class="light">Verficar autorización del dictamen de residencia</h5>
                                        </span>
                                    </div>
                                </div>
                            </div>
