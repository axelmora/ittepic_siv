    ...
    <body>
        ...
        <div class="section no-pad-bot" id="index-banner">
            <div class="container">
                ...
                <div class="row center">
                    ...
                    <?= $this->session->userdata('alias') ?> - Panel de Administración
        ...
        <div class="container">
            <div class="section">
                ...
                <a href="<?php echo base_url(); ?>index.php/Residencia/SubdirectorAcademico/Panel_subdirectoracademico">
                    <div class="col s12 m4 center">
                        <div class="card-panel grey lighten-5 z-depth-1">
                            <div class="row valign-wrapper ">
                                <div class="col s6">
                                ...
                                <div class="col s6">
                                    <span class="black-text">
                                        <h5 class="light">Residencias profesionales</h5>
                                    </span>
                                </div>
                            </div>
                        </div>
