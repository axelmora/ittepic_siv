        ...
        <div class="section no-pad-bot" id="index-banner">
            <div class="container">
                ...
                <div class="row center">
                    <?php foreach ($instancia as $item): ?>
                        <h5 class="condensed light header center amber-text darken-1-text">      
                            Programas de <?= $item->nombre_instancia; ?></h5>
                    <?php endforeach; ?>
                </div>
                <div class="row center">
                    ...
                    <div class="col s6 aling-right">
                        ...
                        <div class="rowsa">
                            ...
                            <?php foreach ($instancia as $item): ?>
                                ...
                                <form method="post" action="<?php echo base_url() . "index.php/c_programasi_i/cp" ?>">

                                    <input class="slide-up" type="text" style="visibility: hidden" name="did" id="did" value="<?= $item->id_instancia; ?>" placeholder="Introduce los datos" /><label for="did"></label>

                            </div> 	

                            <button class="btn amber darken-1 right-align " type="submit">
                                <div class="text-orange"><i class="material-icons left">input</i>Agregar Programa</div>
                            </button>
                ...
                <div class="striped">
                    ...
                    <div class="container_12">
                        ...
                        <table class="bordered">
                            ...
                            <?php if (!$programa_por_instancia) { ?>
                                <span class="red-text text-darken-2">No hay programas para esa instancia </span>
                            ...
                            <?php
                            foreach ($programa_por_instancia as $item) {
                                ?>
                                <tr>
                                    <td >
