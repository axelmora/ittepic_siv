            ...
            <div class="section">
                ...
                <div class="row">
                    ...
                    <?php if (isset($message)) { ?>
                        <CENTER><p class="col s8 center-align card-panel #fff amber lighten-3">Los datos se agregaron correctamente</p></CENTER><br> 
                    <?php } ?>

                    <div class="col s8 center-align card-panel #bdbdbd grey lighten-2"><br><h5 class="medium">AGREGAR INSTANCIA</h5><div class="input-field">
                            <div id="buscador">



                                <?php echo form_open('c_instancias_i'); ?>
                                <br>
                                ...
                                <br>&nbsp; 
                                <div class="rowsa">
                                    <input class="slide-up" type="text" name="nombrei" id="nombrei" value="<?php echo set_value('nombrei'); ?>" placeholder="Introduce los datos" /><label for="nombreid">Nombre de la instancia</label>
                                ...
                                <div class="input-field">
                                    ...
                                    <select  id="sectori" name="sectori" value="<?php echo set_value('sectori'); ?>" class="browser-default">
                                        <option value="<?php echo set_value('sectori'); ?>"><?php echo set_value('sectori'); ?></option>
                                ...
                                <div class="rowsa">
                                    <input class="slide-up" type="text" name="titulari" id="titulari" value="<?php echo set_value('titulari'); ?>" placeholder="Introduce los datos" /><label for="titulari">&nbsp;&nbsp;&nbsp;&nbsp;Nombre del Titular&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                ...
                                <div class="rowsa">
                                    <input class="slide-up" type="text" name="ptitulari" id="ptitulari" value="<?php echo set_value('ptitulari'); ?>" placeholder="Introduce los datos" /><label for="ptitulari">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Puesto del Titular&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                ...
                                <div class="rowsa">
                                    <input class="slide-up" type="text" name="domicilioi" id="domicilioi" value="<?php echo set_value('domicilioi'); ?>" placeholder="Introduce los datos" /><label for="domicilioi">Domicilio de la Instancia</label>
                                ...
                                <div class="rowsa">
                                    <input class="slide-up" type="text" name="telefonoi" id="telefonoi" value="<?php echo set_value('telefonoi'); ?>" placeholder="Introduce los datos" /><label for="telefonoi">&nbsp;Telefono de la Instancia</label>
                                ...
                                <div class="rowsa">
                                    <input class="slide-up" type="text" name="usuarioi" id="usuarioi" value="<?php echo set_value('usuarioi'); ?>" placeholder="Introduce los datos" /><label for="usuarioi">&nbsp;&nbsp;Usuario de la Instancia&nbsp;&nbsp;</label>
                                ...
                                <div class="rowsa">
                                    <input class="slide-up" type="text" name="passi" id="passi" value="<?php echo set_value('passi'); ?>" placeholder="Introduce los datos" /><label for="passi">&nbsp;&nbsp;Contraseña del usuario&nbsp;&nbsp;</label>
                                    <br>&nbsp;
