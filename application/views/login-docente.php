...
<html lang="es">
    ...
    <body>
        <form class="grey lighten-2" method="post" action="<?php echo base_url() . "index.php/LoginDocente" ?>">
            <br>&nbsp;
            <br>&nbsp;
            <div class="rowsa">
                <input class="slide-up tooltipped" type="text" name="rfc" size="13" id="rfc" placeholder="Introduce tu RFC" data-position="top" data-delay="50" data-tooltip="Ingrese el RFC en mayúsculas"/><label for="actividadgi">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RFC&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
            </div>
            <br>&nbsp;
            <br>&nbsp;
            <br>&nbsp;
            <div class="rowsa">
                <input class="slide-up" type="password" name="contrasena"  id="contrasena" placeholder="Introduce tu contraseña" /><label for="actividadgi">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Contraseña&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
            </div>
            <br>&nbsp;
            <br>&nbsp;
