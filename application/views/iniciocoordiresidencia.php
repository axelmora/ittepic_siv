    ...
    <body>
        ...
        <div class="section no-pad-bot" id="index-banner">
            <div class="container">
                ...
                <div class="row center">
                    Coordinador de Residencia Profesional - Panel de Administración
                </div>
                <div class="row center">
        ...
        <div class="container">    
            <div class="section">
                <!--   Icon Section   -->
                <div class="row">
                    <a href="<?php echo base_url(); ?>index.php/Residencia/CoordinadorResidencia/Panel_coordiresidencia/info_procedimiento">
                    ...
                    <a href="<?php echo base_url(); ?>index.php/Residencia/CoordinadorResidencia/Panel_coordiresidencia/asignacion">
                        <div class="col s12 m4 center">       
                            <div class="card-panel grey lighten-5 z-depth-1">
                                <div class="row valign-wrapper ">
                                    <div class="col s6">
                                    ...
                                    <div class="col s8">
                                        <span class="black-text">
                                            <h5 class="light">Asignar asesores y revisores</h5>
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <a href="<?php echo base_url(); ?>index.php/Residencia/CoordinadorResidencia/Panel_coordiresidencia/consulta">
                        <div class="col s12 m4 right">
                            <div class="card-panel grey lighten-5 z-depth-1">
                                <div class="row valign-wrapper">
                                    <div class="col s6">
                                        <img src="<?php echo base_url(); ?>images/proy_por_as.png" alt="" class="circle responsive-img"> <!-- notice the "circle" class -->
                                    </div>
                                    <div class="col s8">
                                        <span class="black-text">
                                            <h5 class="light">Proyectos por asesor y revisor</h5>
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col s12 m4 left">
                            <div class="card-panel grey lighten-5 z-depth-1">
                                <div class="row valign-wrapper">
                                    ...
                                    <div class="col s8">
                                        <span class="black-text">
                                            <h5 class="light">Historial de notificaciones</h5>
                                        </span>
                                    </div>
                                </div>
                            </div>
