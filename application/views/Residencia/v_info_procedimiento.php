...
<head>
  ...
  <title>SIV :: INFORMACIÓN DEL PROCEDIMIENTO</title>
      ...
      <div class="container">
        <div class="row center">
          <h5 class="condensed light header center amber-text darken-1-text">
            Información del procedimiento</h5>
          </div>
        </div>
      </div>
      <div class="container">
        <div class="section">
          ...
          switch ($this->session->userdata('perfil')) {
            ...
            ?>
            <a class = "tooltipped" data-position="top" data-delay="50" data-tooltip="Regresar"
            href="<?php echo base_url() . 'index.php/Residencia/Docente/panel_docente'; ?>">
            <img src="<?php echo base_url(); ?>images/keyboard_return_tiny.png"></a>
            <?php
            break;
            ...
            ?>
            <a class = "tooltipped" data-position="top" data-delay="50" data-tooltip="Regresar"
            href="<?php echo base_url(); ?>index.php/Residencia/SubdirectorAcademico/Panel_subdirectoracademico">
            <img src="<?php echo base_url(); ?>images/keyboard_return_tiny.png"></a>
            <?php
            break;
            default :
          ...
          <div id="content" role="main" align="center">
            <img src="<?php echo base_url(); ?>images/Procedimiento_Residencia.jpg" class="materialboxed" data-caption="Diagrama del procedimiento de residencia profesional" alt="Procedimiento" />
            <br>
