                ...
                <?php if ($residente_info) { ?>
                    ...
                    <div class="center-align col m6 card-panel grey lighten-5">
                        ...
                        <form id="frm_asignar" method="post" action="<?php echo base_url() . "index.php/Residencia/c_asignar_asesor/asignar/" ?>">                                                                        
                            ...
                            <br>
                            <br>
                            Asesor: <label id="a">Sin asesor</label>&nbsp;&nbsp;&nbsp;&nbsp;<a id="asesor" href="#modal_seleccionar_asesor-revisores" class="waves-effect modal-trigger tooltipped" data-position="top" data-delay="50" data-tooltip="Asignar asesor">
                                <img src="<?php echo base_url(); ?>images/queue_tiny.png"></a>&nbsp;&nbsp;&nbsp;&nbsp;<a id="asesor-2" href="#modal_seleccionar_asesor-revisores2" class="waves-effect modal-trigger tooltipped" data-position="top" data-delay="50" data-tooltip="Asignar asesor de otros departamentos">
                                <img src="<?php echo base_url(); ?>images/queue_tiny.png"></a>
                            <br>
                            <br>

                            Revisor 1: <label id="r1">Sin revisor</label>&nbsp;&nbsp;&nbsp;&nbsp;<a id="revisor1" href="#modal_seleccionar_asesor-revisores" class="waves-effect modal-trigger tooltipped" data-position="top" data-delay="50" data-tooltip="Asignar revisor">
                                <img src="<?php echo base_url(); ?>images/queue_tiny.png"></a>&nbsp;&nbsp;&nbsp;&nbsp;<a id="revisor1-2" href="#modal_seleccionar_asesor-revisores2" class="waves-effect modal-trigger tooltipped" data-position="top" data-delay="50" data-tooltip="Asignar revisor de un departamento no académico">
                                <img src="<?php echo base_url(); ?>images/queue_tiny.png"></a>
                            <br>
                            <br>
