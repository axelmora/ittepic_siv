        ...
        <div class="section no-pad-bot" id="index-banner">            
            <div class="row center">
                <h5 class="condensed light header center amber-text darken-1-text">      
                    REGISTRAR APROBACIÓN DE ANTEPROYECTO</h5>
            </div>                
...
<!--                        <form method="post" action="<?php echo base_url() . "index.php/c_alumnos_ds/cambiar_estado/" ?>">-->
 ...
 <div class="col s6 center-align card-panel grey lighten-5">
                ...
                <div class="col s6 center-align card-panel grey lighten-5"><br>ADJUNTAR FORMATO DE REVISION DE ANTEPROYECTO<div class="input-field center-align">
                            <div id="buscador">
                               ...
                               <label>Registrar el estado del anteproyecto</label><!--debe validar que llene ambos-->
                            <br>
                            <br>
                            <select  id="archivoid" name="archivoid">
                                <option value="" disabled selected="">Estado</option>
                                <option value="Residente1">Aprobado</option>
                                <option value="Residente2">No Aprobado</option>                                
                            </select>
                            <br>
                            <br>
