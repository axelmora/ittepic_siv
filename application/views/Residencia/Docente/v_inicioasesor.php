        ...
        <div class="section no-pad-bot" id="index-banner">
            <div class="container">
                ...
                <div class="row center">
                    Asesor - Panel de Administración
                </div>                
            </div>
        </div>
...
<a class = "tooltipped" data-position="top" data-delay="50" data-tooltip="Regresar" 
    ...
    <a href="<?php echo base_url(); ?>index.php/Residencia/Docente/panel_docente/participantes_proyectos">
                                ...
                                <div class="row valign-wrapper">
                                    ...
                                    <div class="col s6">
                                        <span class="black-text">
                                            <h5 class="light">Información de participantes del proyecto</h5>
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <a href="<?php echo base_url(); ?>index.php/Residencia/Docente/panel_docente/bitacora">
                        <div class="col s12 m5 right">
                            ...
                            <div class="card-panel grey lighten-5 z-depth-1">
                                <div class="row valign-wrapper ">
                                    ...
                                    <div class="col s6">
                                        <span class="black-text">
                                            <h5 class="light">Bitácora de avance</h5>
                                        </span>
                                    </div>
                                </div>
                            </div>
