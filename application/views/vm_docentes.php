        ...
        <div class="container">
            <div class="section">
                ...
                <div class="col s6 center-align card-panel grey lighten-5">
                    <table id="tabla_admin_docentes" class="display responsive-table">
                        <thead>
                            <tr>
                                <td>
                                    <b>Departamento</b>
                        ...
                        <tbody>
                            <?php foreach ($docentes as $item): ?>
                                <tr>
                                    ...
                                    <td>
                                        <form method="post" action="<?php echo base_url() . "index.php/cm_docentes/actualizar" ?>">
                                            <input type="text" name="idu" id="idu" style="visibility:hidden; margin-top:-60px; margin-right:20px; vertical-align:" value="<?php echo $item->rfc; ?>"   />
                                            <?= utf8_decode($item->nombres . ' ' . $item->apellidos); ?>
                                    </td>
                                    <td>
                                        <input type="text" style="width: 100%; padding: 5px; border: 1px solid #d4d4d4; border-bottom-right-radius: 5px; border-top-right-radius: 4px; border-bottom-left-radius: 5px; border-top-left-radius: 4px; line-height: 1.5em; float: left; box-shadow: inset 0px 2px 2px #ececec; outline: 0; border: 1px solid #bbb;" name="pass" id="pass" value="<?php echo $item->contrasena; ?>" placeholder="Contraseña"  />
                                    </td>
                                    <td>
