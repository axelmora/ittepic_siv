        ...
        <div class="container">
            <div class="section">
                ...
                <div class="row center-align">
                    ...
                    <div class="col s6 center-align card-panel grey lighten-5"><br>BUSCAR INFORMACION ALUMNO<div class="input-field center-align">
                            <div id="buscador">

                                <span><?php echo validation_errors(); ?></span>
                                <?= form_open(base_url() . 'index.php/alumnos_r/validar') ?>

                                <i class="material-icons prefix">assignment_ind</i>

                                <input type="text" oninput="maxLengthCheck(this)" name="id" value=""  maxlength="8" length="8" id="id" />
                                <label for="search">Numero de Control</label>

                                <button class="btn orange darken-1 z-depth-0 " type="submit">
                                    <div class="text-orange"><i class="material-icons right">supervisor_account</i>BUSCAR</div>
                                </button>
                                <br>
                                <br>
                                <?= form_close() ?>
                ...
                <div class="row center-align">
                    ...
                    <div class="col s6 center-align card-panel grey lighten-5"><br>ALUMNOS REALIZANDO SERVICIO POR PERIODO DE TIEMPO<div class="input-field center-align">
                            <div id="buscador">
                                ...
                                <span><?php echo validation_errors(); ?></span>
                                <?= form_open(base_url() . 'index.php/c_alumnosf_pdf/validar') ?>

                                <i class="material-icons prefix">today</i>

                                <input type="text"  class="datepicker" placeholder="Fecha inicial" name="desde" value=""   id="desde" />



                                <i class="material-icons prefix">today</i>

                                <input type="text" class="datepicker" placeholder="Fecha final" name="hasta" value=""    id="hasta" />
