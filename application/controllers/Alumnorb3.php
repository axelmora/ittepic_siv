...
class Alumnorb3 extends CI_Controller {
    ...
    public function validar() {
        ...
        $this->form_validation->set_rules('totalhb3', 'Horas bimestrales', 'required|min_length[1]|max_length[200]|trim');
        $this->form_validation->set_rules('totalha3', 'Horas acumuladas', 'required|min_length[1]|max_length[200]|trim');
...
// Este método tiene varias opciones, consulta la documentación para más información.
            ...
            $horasacumuladas = $this->input->post('totalha3');
            $horastotales = $this->input->post('totalhb3');
...
<p style='text-align:right'>Reporte No. 3
</p></table>
EOD;
...
<table border="0" align="left" >
 ...
 <tr nobr="true">
  <td colspan="3" >
                        	...
                        	Del día: <u>$item->fecha_reporte2</u> al día: <u>$item->fecha_reporte3</u><br>
...
// Este método tiene varias opciones, consulte la documentación para más información.
            ...
            $nombre_archivo = utf8_decode("Reporte_bimestral_3.pdf");
