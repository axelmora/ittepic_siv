...
class C_alumnosf_pdf extends CI_Controller {
    ...
    public function validar() {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            $pdf->Image(K_PATH_IMAGES . 'lin2.png', 5, 5, 280, 40, 'PNG', '', '', true, 150, '', false, false, 0, false, false, false);
            ...
            $fecha1q = $this->input->post('desde');
            $fecha2q = $this->input->post('hasta');
            ...
            $result = $this->m_alumnosf_pdf->show_data_by_date_range($data);
            ...
            if ($result == 0) {
                $html .= "No hay alumnos registrados haciendo servicio social " . $fecha1q . " y " . $fecha2q . ".";
            } else {

                $html .= "<h2>Alumnos con programa de servicio social registrado entre " . $fecha1q . " y " . $fecha2q . " </h2><h4>Hay: " . count($result) . " Alumnos</h4>";
