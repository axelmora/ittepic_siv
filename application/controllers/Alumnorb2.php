...
class Alumnorb2 extends CI_Controller {
    ...
    public function validar() {
        ...
        $this->form_validation->set_rules('totalhb2', 'Horas bimestrales', 'required|min_length[1]|max_length[200]|trim');
        $this->form_validation->set_rules('totalha2', 'Horas acumuladas', 'required|min_length[1]|max_length[200]|trim');
...
// Este método tiene varias opciones, consulta la documentación para más información.
            ...
            $horasacumuladas = $this->input->post('totalha2');
            $horastotales = $this->input->post('totalhb2');
...
<p style='text-align:right'>Reporte No. 2
</p></table>
EOD;
...
<table border="0" align="left" >
 ...
 <tr nobr="true">
  <td colspan="3" >
                        	...
                        	Del día: <u>$item->fecha_reporte1</u> al día: <u>$item->fecha_reporte2</u><br>
...
// Este método tiene varias opciones, consulte la documentación para más información.
            ...
            $nombre_archivo = utf8_decode("Reporte_bimestral_2.pdf");
